...
try:
    with open('D:\\Code\\GUI\\image_load\\generated\\mPythonImages\\mp-431921854.png','rb') as f:
        screen_img_1_img_data = f.read()
except:
    print('Could not open D:\\Code\\GUI\\image_load\\generated\\mPythonImages\\mp-431921854.png')
    sys.exit()
